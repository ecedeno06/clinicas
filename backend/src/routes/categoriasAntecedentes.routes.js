...
const ctrl = require('../controllers/categoriasAntecedentes.controller');
const { requireAuth, requireSuperAdmin } = require('../middleware/auth');

// Catalogo global: lectura para cualquier usuario logueado (de cualquier
// clinica), escritura solo para super admin -- por eso NO se usa
// router.use(requireAuth, requireSuperAdmin) como en empresas.routes.js.
